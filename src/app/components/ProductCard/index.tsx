      ...
      <div className="product-card-container w-[171px] xl:w-[318px]">
        ...
        <div className="product-information-container">
          ...
          <div className="view-product-button">
            <button className="bg-shelf-black xl:py-[15.5px] py-[13px] lg:px-10 px-[16px] w-full rounded-lg text-shelf-white xl:font-semibold font-medium xl:text-[14px] text-[12px]">
