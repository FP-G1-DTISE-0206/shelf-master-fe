...
const ProductSuggestion: FC<ProductSuggestionProps> = ({
  ...
  const { products, error, isLoading, params, setParams } =
        ...
        {showCarousel && (
          <div className="flex gap-2">
            <button
              ...
              className="p-2 bg-shelf-grey text-shelf-white rounded-lg"
            >
            ...
            <button
              ...
              className="p-2 bg-shelf-black text-shelf-white rounded-lg"
            >
